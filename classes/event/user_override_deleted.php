...
/**
 * The mod_publication user override deleted event.
 *
...
/**
 * The mod_publication user override deleted event class.
 *
...
class user_override_deleted extends \core\event\base {
    ...
    public function get_url() {
        return new \moodle_url('/mod/publication/overrides.php', array('id' => $this->contextinstanceid));
    }
