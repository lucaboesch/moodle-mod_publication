...
/**
 * The mod_publication group override created event.
 *
...
/**
 * The mod_publication group override created event class.
 *
...
class group_override_created extends \core\event\base {
    ...
    public function get_url() {
        return new \moodle_url('/mod/publication/overrideedit.php', ['id' => $this->objectid]);
    }
