...
$string['allowshowgroupnames'] = 'Teachers can show/hide group names';
$string['allowshowgroupnames_desc'] = 'If enabled, teachers can change the "Show group names" setting in each activity instance. If disabled, the default setting below is enforced for all instances.';
$string['allowshowlastmodified'] = 'Teachers can show/hide last modified date';
$string['allowshowlastmodified_desc'] = 'If enabled, teachers can change the "Show last modified date" setting in each activity instance. If disabled, the default setting below is enforced for all instances.';
$string['allowshowparticipantnames'] = 'Teachers can show/hide participant names';
$string['allowshowparticipantnames_desc'] = 'If enabled, teachers can change the "Show participant names" setting in each activity instance. If disabled, the default setting below is enforced for all instances.';
...
* Students and/or teachers will receive a notification when students upload or change a file or when a file is imported or updated from an assignment activity. Furthermore students and/ or teachers will receive a notification about any changes of the publication status.
...
$string['notice_hidden_date'] = '<strong>The last modified date</strong> is <strong>not visible</strong> to other participants.';
$string['notice_hidden_name'] = '<strong>Your name</strong> is <strong>not visible</strong> to other participants.';
$string['notice_hidden_namedate'] = '<strong>Your name and the last modified date</strong> are <strong>not visible</strong> to other participants.';
...
$string['privacy:metadata:allowsubmissionsfromdate'] = 'The overridden date from which students may start submitting.';
$string['privacy:metadata:approval'] = 'Whether the group member has approved or rejected for publication.';
$string['privacy:metadata:approvalfromdate'] = 'The overridden start of the approval window.';
$string['privacy:metadata:approvaltodate'] = 'The overridden end of the approval window.';
$string['privacy:metadata:contenthash'] = 'SHA1 hash of the file\'s content, used to determine if the file changed.';
$string['privacy:metadata:duedate'] = 'The overridden date by which students must submit.';
...
$string['privacy:metadata:groupid'] = 'Identifier of the group the override applies to.';
$string['privacy:metadata:overrides'] = 'Stores per-user and per-group overrides of the publication\'s submission and approval dates.';
...
$string['showgroupnames'] = 'Show group names';
$string['showgroupnames_admin'] = 'Default setting for "Show group names"';
$string['showgroupnames_admin_desc'] = 'This setting determines the default for whether group names are displayed to other participants for published file submissions.';
$string['showgroupnames_help'] = 'This option determines whether group names are displayed to all other participants for published file submissions. The group names always remain visible to teachers.';
$string['showlastmodified'] = 'Show last modified date';
$string['showlastmodified_admin'] = 'Default setting for "Show last modified date"';
$string['showlastmodified_admin_desc'] = 'This setting determines the default for whether the "Last modified" date is displayed for published file submissions.';
$string['showlastmodified_help'] = 'This option determines whether the "Last modified" date is displayed for published file submissions. The date always remains visible to teachers.';
$string['showparticipantnames'] = 'Show participant names';
$string['showparticipantnames_admin'] = 'Default setting for "Show participant names"';
$string['showparticipantnames_admin_desc'] = 'This setting determines the default for whether the names of participants are displayed to other participants for published file submissions.';
$string['showparticipantnames_help'] = 'This option determines whether the names of participants (i.e., authors) are displayed to all other participants for published file submissions. The names always remain visible to teachers.';
